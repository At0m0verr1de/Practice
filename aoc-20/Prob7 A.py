"""
    ...
    LR = 1 BW(1 SG) + 2 MY(2 SG, 9 FB)

    DO = 3 BW(1 SG) + 4 MY(2 SG, 9 FB)

    BW = 1 SG

    MY = 2 SG + 9 FB

    SG = 1 DOL(3 FB, 4 DB) + 2 VP(5 FB, 6 DB)
...
dataset = """bright olive bags contain 5 dotted white bags, 2 wavy lavender bags.
...
dotted bronze bags contain 2 muted tomato bags.""".split("\n")
